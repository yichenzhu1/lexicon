...
struct SettingsView: View {
    ...
    var body: some View {
        ...
        .confirmationDialog(
            ...
            Text("All preferences will return to their defaults, including the 100-word history limit. Older history beyond that limit will be removed. Your API keys, dictionaries, and starred words will be kept.")
        }
    }
        ...
        settingsPage {
            Form {
                Section("Search") {
                    ...
                    shortcutRow("Open the selected result", shortcut: "↩")
                }
